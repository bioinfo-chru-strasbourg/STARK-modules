...
system("umask 006");
$bin = ".";
$srcdir = "../src/src_for_csh/established_and_tested_src_for_csh";
$tmp = "../tmp";
$pid = $$;
...
system("$program_call $$ alignedseqs $alignedseq $out 27 $subst_file $gap_option $exp_option > $comments 2>/dev/null");
