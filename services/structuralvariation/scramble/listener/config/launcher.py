...
print os.getenv('DOCKER_STARK_INNER_FOLDER_CONFIG')
print os.getenv('DOCKER_STARK_MODULE_NAME')
print os.getenv('DOCKER_STARK_MODULE_SUBMODULE_NAME')
print os.getenv('DOCKER_STARK_MODULE_SUBMODULE_SERVICE_LISTENER_NAME')
print(configFile)
